...
const ForgotPassword = ({ navigation }) => {
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={{ flexDirection:"column", justifyContent:"center", alignItems:"center", gap:10, paddingTop:130, paddingBottom:10 }}>
        <Image style={styles.logo} source={require(`${IMG_PATH}/logo.png`)} />
        <Text style={{ fontSize: 18, color: "#000", fontWeight: 600, marginTop:30 }}>Forgot your password?</Text>
        <Text style={{ fontSize: 12, color: "#8a8a8a", paddingHorizontal:50, textAlign:"center" }}>Reset password you can create new if your email or phone is correct user.</Text>
      </View>
